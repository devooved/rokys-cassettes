...
function setLanguage(language) {
    ...
    if (language === "en") {
        ...
        homeText.innerHTML = `
            <span>Ο Ροκυ ήταν φωτογράφος και ζούσε στη Δίκαια (Έβρος).</span>
            ...
            <span>Δημιούργησα αυτόν τον ιστότοπο ώστε να μπορείς να λάβεις μια τυχαία μουσική πρόταση από τον Ροκυ.</span>
        `;
